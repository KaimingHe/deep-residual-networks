...
0. Caffe implementation for [resnets described in paper with some tweaked architectures.](https://github.com/jay-mahadeokar/pynetbuilder) These can be generated using using [pynetbuilder](https://github.com/jay-mahadeokar/pynetbuilder), a python tool for generating caffe networks programmatically. 
